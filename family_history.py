...
def print_marriages(marriages_dict, people_dict):
    ...
    for key, value in marriages_dict.items():
        ...
        # husband
        husband_value = people_dict[husband_id]
        husband_name = husband_value[NAME_INDEX]
        husband_year = husband_value[BIRTH_YEAR_INDEX]
        husband_age = wedding_year - husband_year

        # wife
        wife_value = people_dict[wife_id]
        wife_name = wife_value[NAME_INDEX]
        wife_year = wife_value[BIRTH_YEAR_INDEX]
        wife_age = wedding_year - wife_year
